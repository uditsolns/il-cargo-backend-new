...
class ChecklistController extends Controller
{
    ...
    public function index()
    {
        ...
        $checklists = Checklist::with('cargo', 'phase', 'zone')->latest()->get();
    ...
    public function store(Request $request)
    {
        ...
        $preferred_compliances = $request->input('preferred_compliances') ?? [];
        $sop_breaches = $request->input('is_sop_breached') ?? [];
        ...
        try {
            ...
            Checklist::query()->where('cargo_id', $cargo_id)
                ->where("phase_id", $phase_id)
                ->where("zone_id", $zone_id)->delete();
            ...
            foreach ($questions as $key => $question) {
                ...
                $checklistItems[] = [
                    ...
                    'answer' => $answer,
                    'preferred_compliance' => $preferred_compliances[$key],
                    'is_sop_breached' => $sop_breaches[$key],
